...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/home/wilder/Documents/Challenges Wild/symfony/wild-series/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
