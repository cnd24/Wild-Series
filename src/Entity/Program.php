...
class Program
{
     ...
     * @Assert\NotBlank(message="Le title doit être renseigné")
     ...
     * @Assert\NotBlank(message="Le résumé doit être renseigné")
     * @Assert\Regex(
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Season", mappedBy="program", cascade={"remove"})
     */
    private $seasons;
